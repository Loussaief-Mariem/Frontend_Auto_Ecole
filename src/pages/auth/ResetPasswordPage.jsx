...
import { resetPassword, verifyToken } from "../../api/authService";
import {
  useNavigate,
  useSearchParams,
  Link as RouterLink,
...
const ResetPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Erreur lors de la réinitialisation. Le lien est peut-être expiré.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <Box sx={authPageSx}>
      <Paper elevation={0} sx={authPaperSx}>
        ...
        {isTokenValid === null ? (
          <Typography textAlign="center">Vérification du lien en cours...</Typography>
        ) : isTokenValid === false ? (
          <Box textAlign="center" mb={3}>
            <Typography color="error" mb={2} fontWeight={600}>
